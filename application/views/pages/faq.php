...
<div class="FAQ-wrapper">
  ...
  <div class="half">
    ...
    <div class="tab blue">
      ...
      <div class="tab-content">
        <p>To apply for a job, go to GigCentral.com website. If you are on GigCentral.com, go to the Find a gig page and enter search criteria in the boxes for Job Title, Keyword, and/or City or State. You can also search by clicking a Category or Location.
					<ul>
    ...
    <div class="tab blue">
      ...
      <div class="tab-content">
        <p>There are several places where you may find an organization's contact information:
					<ul>
    ...
    <div class="tab blue">
      <input id="tab-nine" type="checkbox" name="tabs2">
    ...
    <div class="tab blue">
      <input id="tab-ten" type="checkbox" name="tabs2">
      <label for="tab-ten">How do I change my password?</label>
      <div class="tab-content">
        <p>If you wish to change your password, please follow these steps: 
					<ol>
