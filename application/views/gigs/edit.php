...
<div class="container">
  <div class="col-lg-10">
      <!-- Fetching All Details of Selected Student From Database And Showing In a Form -->
        ...
        <?php foreach ($single_company as $company): ?>
        <fieldset>
            ...
            <div class="form-group">
                <label for="Name" class="col-lg-3 control-label"><em>Company Name</em></label>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="Name" name="Name" placeholder="Company Name" value="<?php echo $company->Name; ?>">
                    </div>
            </div>
            <div class="form-group">
                <label for="CompanyAddress" class="col-lg-3 control-label"><em>Company Address</em></label>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="Address" name="Address" placeholder="Address" value="<?php echo $company->Address; ?>">
                    </div>
            </div>
            <div class="form-group">
                <label for="CompanyCity" class="col-lg-3 control-label"><em>City</em></label>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="CompanyCity" name="CompanyCity" placeholder="City" value="<?php echo $company->CompanyCity; ?>">
                    </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="ZipCode" class="col-lg-3 control-label"><em>Zip Code</em></label>
                    <div class="col-md-6">
                        <input type="text" class="form-control" id="ZipCode" name="ZipCode" placeholder="Zip Code" value="<?php echo $company->ZipCode; ?>">
                    </div>
            </div>
            <div class="form-group">
                <label for="CompanyPhone" class="col-lg-3 control-label"><em>Company Phone</em></label>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="CompanyPhone" name="CompanyPhone" placeholder="Phone Number" value="<?php echo $company->CompanyPhone; ?>">
                    </div>
            </div>
            <div class="form-group">
                <label for="Website" class="col-lg-3 control-label"><em>Company Website</em></label>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="Website" name="Website" placeholder="Company Website" value="<?php echo $company->Website; ?>">
                    </div>
            </div>
            <br>
            <?php endforeach; ?>
            ...
            <br>
            <?php foreach ($single_company_contact as $company_contact): ?>
                <fieldset>
            ...
            <div class="form-group">
                <label for="FirstName" class="col-lg-3 control-label"><em>First Name</em></label>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="FirstName" name="FirstName" placeholder="First Name" value="<?php echo $company_contact->FirstName; ?>">
                    </div>
            </div>
            <div class="form-group">
                <label for="LastName" class="col-lg-3 control-label"><em>Last Name</em></label>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="LastName" name="LastName" placeholder="Last Name" value="<?php echo $company_contact->LastName; ?>">
                    </div>
            </div>
            <div class="form-group">
                <label for="Email" class="col-lg-3 control-label"><em>Email</em></label>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="Email" name="Email" placeholder="Gig Contact Email" value="<?php echo $company_contact->Email; ?>">
                    </div>
            </div>
            <div class="form-group">
                <label for="Phone" class="col-lg-3 control-label"><em>Phone</em></label>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="Phone" name="Phone" placeholder="Gig Contact Phone" value="<?php echo $company_contact->Phone; ?>">
                    </div>
            </div>
            </fieldset>
            <?php endforeach; ?>
...
<?php foreach ($single_gig as $gig): ?>
        ...
        <fieldset>
            <div class="col-xs-12 col-md-6 col-lg-9">
                <button type="submit" name="submit" "btn btn-default pull-right">Submit Changes</button>
            </div>
        </fieldset>
        </form>
    </div>
