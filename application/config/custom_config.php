...
$config['smtp_user'] = 'thomas.harrington@seattlecentral.edu';
$config['smtp_pass'] = '';
...
$config['email_contact_sendto'] = "thomas.harrington@seattlecentral.edu";
...
$config['recaptcha_sitekey'] = "6LcPUYkUAAAAAC9HwGKFx_y6HjjNLtbe624_DY3Y";
$config['recaptcha_secretkey'] = "6LcPUYkUAAAAAMhBEPy70hJ_-xqfxdpqasU9-nFU";
$config['lang'] = "";
