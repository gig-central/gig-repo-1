...
ON DUPLICATE KEY UPDATE `CompanyID` = VALUES(`CompanyID`), `Name` = VALUES(`Name`), `Address` = VALUES(`Address`), `CompanyCity` = VALUES(`CompanyCity`), `CompanyState` = VALUES(`CompanyState`), `ZipCode` = VALUES(`ZipCode`), `CompanyPhone` = VALUES(`CompanyPhone`), `Website` = VALUES(`Website`), `CompanyContactID` = VALUES(`CompanyContactID`);
